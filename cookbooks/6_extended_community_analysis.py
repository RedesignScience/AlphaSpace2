...
# ASA, [Å²] for community 2, etc. The communities are saved as separate residues with nonpolar spaces as b factor columns for easy visualization. 
# community_properties is a tuple of thee elements - the first is a list of community properties (the same ones saved in protein.npy), the second is a dictionary of
# the communities and their constituent pockets, the third is a list of all pockets in the snapshot. 
