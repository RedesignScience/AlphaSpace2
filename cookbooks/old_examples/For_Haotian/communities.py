...
def genCommunityPocket(prot_coords, centroid_dict, space_dict, contact_index_dict, score_dict, corecut = 100, auxcut = 30, tight_option = True, tight_cutoff_core = 12.5, tight_cutoff_aux = 6.5):
    """
