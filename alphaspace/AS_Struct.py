...
#                 return Pocket(self._pockets_alpha_idx[snapshot_idx][pocket_idx], snapshot_idx, pocket_idx, self)
#             else:
#                 return None
#         else:
#             return None
